...
<?php if(isset($_SESSION['userdata']) && $_SESSION['userdata']['login_type'] == 1): ?>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/inflation_projection" class="nav-link nav-inflation_projection">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/investment_planner" class="nav-link nav-investment_planner">
...
<?php elseif(isset($_SESSION['userdata']) && $_SESSION['userdata']['login_type'] == 0): ?>
                    <li class="nav-item dropdown">
                      <a href="./" class="nav-link nav-home">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
